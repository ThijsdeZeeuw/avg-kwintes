...
def save_secrets_to_file(env_vars):
    ...
    with open(secrets_file, 'w') as f:
        ...
        f.write(f"Supabase Dashboard: {env_vars.get('DASHBOARD_USERNAME', 'admin')} / {env_vars.get('DASHBOARD_PASSWORD', '')}\n")
...
def main():
    ...
    parser.add_argument('--interactive', action='store_true', default=True,
                      help='Create .env file interactively (default: True)')
    args = parser.parse_args()

    # Always create .env file interactively
